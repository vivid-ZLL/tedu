...
以此形成可以同时处理多个IO的行为，避免一个IO阻塞造成其他IO均无法执行，提高IO执行效率。

相比于http1.0 可以同时监听多个访问,
仅添加一种通过"http://127.0.0.1:8000/alice.html",这样的形式访问html文件
"""
...
class HTTPServer:
    ...
    def get_html(self, connfd, info):
        ...
        try:
            ...
            response += '\r\n'
            response += '<h1>Sorry....file not found</h1>'
        else:
            # 网页存在
